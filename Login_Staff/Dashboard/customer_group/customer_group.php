    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="../dashboard_home.php"><img src="../../../static/hijack_sandals_web_logo.png"
                        alt=""></a>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link nav-icons active" href="customer_group.php"><i
        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Customer Group </h2>
                ...
                ?>
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-header bg-primary">Group <?php echo $group_object['id_group'];?></div>
                            <div class="card-body">
                                <h1 class="card-text"><?php echo $group_object['nama_group']?> </h1>
                                <p class="card-text text-justify">
                                    <?php echo mb_substr($group_object['des_group'],0, 150)."..." ?>
                                </p>
                            </div>
                            <div class="card-footer p-0 text-center">
                                <div class="card-footer-item card-footer-item-bordered">
                                <?php
                                    echo ("<a href='group_detail.php?id_group=$group_object[id_group]' class='card-link'>Show More Detail</a>");
                                ?>
                                </div>
                            </div>
                        </div>
                ...
                ?>
                    <!-- <div class="col-md-3">
                        <div class="card">
                            <div class="card-header bg-primary">Group 1</div>
                            <div class="card-body">
                                <h1 class="card-text">Old Schooler</h1>
                                <p class="card-text">Vestibulum ante ipsum orci luctus et ultrices posuere cger quis
                                    ipsum in augue posuere congue.</p>
                            </div>
                            <div class="card-footer p-0 text-center">
                                <div class="card-footer-item card-footer-item-bordered">
                                    <a href="group_detail.php">Show
                                        more Detail</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-header bg-primary">Group 1</div>
                            <div class="card-body">
                                <h1 class="card-text">kaum Jelata</h1>
                                <p class="card-text">Vestibulum ante ipsum orci luctus et ultrices posuere cger quis
                                    ipsum in augue posuere congue.</p>
                            </div>
                            <div class="card-footer p-0 text-center">
                                <div class="card-footer-item card-footer-item-bordered">
                                    <a href="#" class="card-link">Show more Detail</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-header bg-primary">Group 1</div>
                            <div class="card-body">
                                <h1 class="card-text">Borjouis</h1>
                                <p class="card-text">Vestibulum ante ipsum orci luctus et ultrices posuere cger quis
                                    ipsum in augue posuere congue.</p>
                            </div>
                            <div class="card-footer p-0 text-center">
